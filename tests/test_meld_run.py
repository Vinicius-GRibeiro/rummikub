...
def test_valid_unordered_sequence_3_tiles_no_joker():
...
def test_valid_unordered_sequence_2_tiles_1_joker():
...
def test_valid_multiple_jokers():
    tiles = [Tile.create_joker(), Tile(Color.YELLOW, 3), Tile(Color.YELLOW, 4), Tile(Color.YELLOW, 7), Tile.create_joker()]
    run = Run(tiles)
